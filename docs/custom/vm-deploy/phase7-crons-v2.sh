...
add "macro-mood-check" \
  ...
  --session isolated --announce --channel whatsapp --to "$TO" \
  --message "Use sparky_fitness with action summary to get macro progress. Show the summary then ask: 'Energy 1-10? Stress 1-10? Reply: e7 s4'"
